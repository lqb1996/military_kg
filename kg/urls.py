...
urlpatterns = [
    ...
    url(r'^minStructure/$', views.minStructure),
    url(r'^expressLearn/$', views.expressLearn),
    url(r'^baike/$', views.expressLearn),
    url(r'^mixed/$', views.mixed),
    url(r'^non_ner/$', views.non_ner),
    url(r'^vector/$', views.vector),
    url(r'^syn/$', views.mixed_syn),
